...
LOCKED_FILE_HASHES = {
    ...
    PLAN_PATH: "0bfbc52f157fa9ce9ad8425e0bf32f2617c729dbb2281395101f6ed244f69294",
    "grammar/Pietto.g4": (
    ...
    "docs/spec/diagnostics.md": (
        "cef21caeb60baa86ef91fc275f8e03d8b2c4111525f50bad46f6de8632027139"
    ),
    "pyproject.toml": (
...
LOCKED_GROUP_HASHES = {
    ...
    "semantic": (
        17,
        "9beea62ce31125079207b30471dcccc1a08a3eb39bbc3a67a1b767f46faaa014",
    ),
    "ir": (
        5,
...
def test_phase16_documents_and_four_slice_status_are_exact() -> None:
    ...
    for required in (
        "**Phase 16 Slice 2: Safety Surface and Strict Mode Contract is planned "
        "only.**",
        ...
        "does not authorize the next slice or any production change",
    ):
...
def test_status_docs_record_slice1_without_implementation_authorization() -> None:
    for path in STATUS_PATHS:
        ...
        assert "Slices 2 through 4" in normalized
