    ...
    *,
    ...
    return _record(
        ...
        (
            ...
            pure_text(
                target_module_path if resolved_target is None else resolved_target[0]
            )
            if resolved
            else PURE_ABSENT,
        ),
        ...
        (
            ...
            pure_text(exported_name if resolved_target is None else resolved_target[1])
            if resolved
            else PURE_ABSENT,
        ),
...
def _origin_hop(
    ...
    *,
    ...
    return _record(
        ...
        ("import_module_statement_position", pure_integer(statement)),
        ("import_item_position", pure_integer(item)),
    ...
    return {
        ...
        "alias_distinct_from_target": (
            ...
            _document(
                ...
                *_module_block(1, "b.pietto"),
                _export(1, 0, local_name="Exported", module_path="b.pietto"),
                _declaration(1, 0, owner_name="b.pietto", declared_name="Exported"),
            ),
        ),
        ...
        "explicit_reexport": (
            ...
            _document(
                ...
                *_importing_module_block(
                ...
                _origin_hop(1, 0, 0, module_path="c.pietto", exported_name="Row"),
                *_module_block(2, "c.pietto"),
                _export(2, 0, local_name="Row", module_path="c.pietto"),
                _declaration(2, 0, owner_name="c.pietto", declared_name="Row"),
                _origin(
                    2,
                    0,
                    local_name="Row",
            ...
            _document(
                ...
                *(
                    ...
                    for index, (path, target) in enumerate(
                        (("a.pietto", "b.pietto"), ("b.pietto", "a.pietto"))
                    )
                    for record in (
                        _module(index, path),
                        _digest(index),
                        ...
                        _graph(index, cyclic=True, members=2, targets=1, evidence=1),
                        _component_member(index, 0, "a.pietto"),
                        _component_member(index, 1, "b.pietto"),
                        _dependency_target(index, 0, target),
                        _import_evidence(index, 0, target),
                        _import(
                            index,
                            0,
                            local_name="Row",
            ...
            _document(
                ...
                *_module_block(0, "a.pietto"),
                _declaration(
                    ...
                    relation_reason="unknown_schema",
                ),
                _semantic_facts(
                    0,
                    0,
                ...
                _select(0, 0, 1, selected_output_ordinal=1, output_name="rank"),
                _select(0, 0, 2, selected_output_ordinal=2, output_name=None),
                _clause_dependency(
                    0,
                    0,
                    0,
        ...
        "boundary_cardinalities": (
            ...
            _document(
                ...
                *(
                    ...
                    for record in (
                        _module(index, f"{'abc'[index]}.pietto"),
                        _digest(index),
                        _readiness(
                            index,
                            status="blocked",
                        ...
                        *(
                            ...
                            for member in (
                                _cycle(index, cycle, 3),
                                _cycle_member(index, cycle, 0, "a.pietto"),
                                _cycle_member(index, cycle, 1, "b.pietto"),
                                _cycle_member(index, cycle, 2, "c.pietto"),
                            )
                        ),
                        _graph(index, cyclic=True, members=3, targets=0, evidence=0),
                        _component_member(index, 0, "a.pietto"),
                        _component_member(index, 1, "b.pietto"),
        ...
        "type_alias_chain": (
            ...
            _document(
                ...
                _OWNER,
                *_module_block(0, "a.pietto"),
                _declaration(0, 0, owner_name="a.pietto", declared_name="Person"),
                _declaration(
                    0,
                    1,
                    owner_name="a.pietto",
        ...
        "dependency_target_variants": (
            ...
            _document(
                ...
                *_module_block(0, "a.pietto"),
                ...
                _row_field(0, 2, 0, name="id"),
                _row_field(0, 2, 1, name="total"),
                _origin(
                    0,
                    0,
                    local_name="Row",
                ...
                _dependency(
                    ...
                    owner_position=1,
                    declaration_target=("a.pietto", 0, "Row"),
                ),
                _dependency(
                    0,
                    1,
                    ...
                    owner_position=2,
                    declaration_target=("a.pietto", 1, "rows"),
                ),
                _dependency(
                    0,
                    2,
        ...
        "boolean_values": (
            ...
            _document(
                ...
                *_module_block(1, "b.pietto"),
                ...
                _semantic_facts(1, 0, let_bindings=2),
                _let_binding(1, 0, 0, binding_ordinal=0, has_value_type=True),
                _let_binding(1, 0, 1, binding_ordinal=1, has_value_type=False),
            ),
        ),
        "resolution_sections": (
...
def _rejected_vectors() -> tuple[DifferentialVector, ...]:
    ...
    return (
        ...
        _rejected(
            "fixed_role_outside_member_zero",
            DifferentialPurpose.FIXED_ROLE_OUTSIDE_MEMBER_ZERO,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "direct_canonical_kind_mismatch",
            DifferentialPurpose.DIRECT_CANONICAL_KIND_MISMATCH,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "alias_base_outside_member_zero",
            DifferentialPurpose.ALIAS_BASE_OUTSIDE_MEMBER_ZERO,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "window_output_outside_select_ledger",
            DifferentialPurpose.WINDOW_OUTPUT_OUTSIDE_SELECT_LEDGER,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                _semantic_facts(0, 0, selects=1, window_outputs=1),
                _select(0, 0, 0, selected_output_ordinal=0, output_name="id"),
                _window_output(
                    0,
                    0,
        ...
        _rejected(
            "foreign_component_member",
            DifferentialPurpose.FOREIGN_COMPONENT_MEMBER,
            _document(
                _header(1),
                _OWNER,
                _module(0, "a.pietto"),
        ...
        _rejected(
            "unordered_cycle_members",
            DifferentialPurpose.UNORDERED_CYCLE_MEMBERS,
            _document(
                _header(2),
                _OWNER,
                _module(0, "a.pietto"),
                ...
                _cycle(0, 0, 2),
                _cycle_member(0, 0, 0, "b.pietto"),
                _cycle_member(0, 0, 1, "a.pietto"),
                _graph(0, cyclic=True, members=2),
                _component_member(0, 0, "b.pietto"),
                _component_member(0, 1, "a.pietto"),
                *_module_block(1, "b.pietto"),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
        ...
        _rejected(
            "unordered_dependency_targets",
            DifferentialPurpose.UNORDERED_DEPENDENCY_TARGETS,
            _document(
                _header(3),
                _OWNER,
                _module(0, "a.pietto"),
                _digest(0),
                _readiness(0),
                _graph(0, targets=2, evidence=2),
                _component_member(0, 0, "a.pietto"),
                _dependency_target(0, 0, "c.pietto"),
                _dependency_target(0, 1, "b.pietto"),
                _import_evidence(0, 0, "c.pietto"),
                _import_evidence(0, 1, "b.pietto", item=1),
                _import(
                    0,
                    0,
                    local_name="Third",
        ...
        _rejected(
            ...
            DifferentialPurpose.CLAUSE_AMBIGUITY_WITHOUT_BLOCKED_WINDOWS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                _semantic_facts(
                    ...
                    0,
                    status="blocked",
                    reason="conflicting_aggregate_or_grouped_facts",
                    selects=1,
                    clause_dependencies=1,
                    window_outputs=1,
                ),
                _select(0, 0, 0, selected_output_ordinal=0, output_name="rank"),
                _clause_dependency(
                    0,
                    0,
                    0,
        ...
        _rejected(
            "evidence_outside_import_ledger",
            DifferentialPurpose.EVIDENCE_OUTSIDE_IMPORT_LEDGER,
            _document(
                _header(2),
                _OWNER,
                _module(0, "a.pietto"),
        ...
        _rejected(
            "row_fields_without_schema_state",
            DifferentialPurpose.ROW_FIELDS_WITHOUT_SCHEMA_STATE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                _declaration(
                    ...
                    relation_status="deferred",
                    relation_reason="aggregate_grouped_deferred",
                    row_fields=1,
                ),
                _row_field(0, 0, 0, name="id"),
            ),
        ...
        _rejected(
            ...
            DifferentialPurpose.BLOCKED_AVAILABILITY_WITHOUT_STATE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "cycle_issue_without_a_cycle",
            DifferentialPurpose.CYCLE_ISSUE_WITHOUT_A_CYCLE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "cycle_issue_outside_first_member",
            DifferentialPurpose.CYCLE_ISSUE_OUTSIDE_FIRST_MEMBER,
            _document(
                _header(2),
                _OWNER,
                *(
                    ...
                    for record in (
                        ...
                        _cycle_member(index, 0, 0, "a.pietto"),
                        _cycle_member(index, 0, 1, "b.pietto"),
                        _graph(index, cyclic=True, members=2),
                        _component_member(index, 0, "a.pietto"),
                        _component_member(index, 1, "b.pietto"),
                        *(
                            (
        ...
        _rejected(
            "lineage_field_outside_row_schema",
            DifferentialPurpose.LINEAGE_FIELD_OUTSIDE_ROW_SCHEMA,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "row_field_member_outside_row_schema",
            DifferentialPurpose.ROW_FIELD_MEMBER_OUTSIDE_ROW_SCHEMA,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _dependency(
                    ...
                    reference_role="row_field",
                    member_position=1,
                    row_field_target=(0, "source_field", 0, "id"),
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            10,
        ...
        _rejected(
            ...
            DifferentialPurpose.RESOLVED_TARGET_OUTSIDE_SELECTED_MODULES,
            _document(
                _header(2),
                _OWNER,
                *_importing_module_block(
        ...
        _rejected(
            "local_lineage_root_outside_row_schema",
            DifferentialPurpose.LOCAL_LINEAGE_ROOT_OUTSIDE_ROW_SCHEMA,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            ...
            DifferentialPurpose.LOCAL_CANONICAL_TARGET_OUTSIDE_DECLARATIONS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _type_resolution(
                    ...
                    direct_kind="enum",
                    canonical_kind="enum",
                    canonical_target=("a.pietto", "Status"),
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            0,
        ...
        _rejected(
            "local_alias_outside_declarations",
            DifferentialPurpose.LOCAL_ALIAS_OUTSIDE_DECLARATIONS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "lineage_root_outside_selected_modules",
            DifferentialPurpose.LINEAGE_ROOT_OUTSIDE_SELECTED_MODULES,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "nameless_cycle_issue_without_a_cycle",
            DifferentialPurpose.NAMELESS_CYCLE_ISSUE_WITHOUT_A_CYCLE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "lineage_field_kind_outside_owner",
            DifferentialPurpose.LINEAGE_FIELD_KIND_OUTSIDE_OWNER,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            ...
            DifferentialPurpose.SOURCE_SHAPE_RESOLUTION_TO_RELATION_ORIGIN,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "relation_resolution_to_type_origin",
            DifferentialPurpose.RELATION_RESOLUTION_TO_TYPE_ORIGIN,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _declaration(0, 1, owner_name="a.pietto", declared_name="Row"),
                _origin(
                    0,
                    0,
                    local_name="totals",
        ...
        _rejected(
            "repeated_origin_hop",
            DifferentialPurpose.REPEATED_ORIGIN_HOP,
            _document(
                _header(2),
                _OWNER,
                *_importing_module_block(
                ...
                *(
                ...
                _origin_hop(0, 0, 2, module_path="c.pietto", exported_name="Row"),
                *_module_block(1, "b.pietto"),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            12,
        ...
        _rejected(
            "resolved_import_without_a_facade",
            DifferentialPurpose.RESOLVED_IMPORT_WITHOUT_A_FACADE,
            _document(
                _header(2),
                _OWNER,
                *_importing_module_block(
        ...
        _rejected(
            "facade_target_without_a_declaration",
            DifferentialPurpose.FACADE_TARGET_WITHOUT_A_DECLARATION,
            _document(
                _header(2),
                _OWNER,
                *_importing_module_block(
        ...
        _rejected(
            ...
            DifferentialPurpose.SPARSE_SHAPE_FIELD_RESOLUTIONS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                _declaration(0, 0, owner_name="a.pietto", declared_name="Person"),
                _type_resolution(0, 0, canonical_name="Int", member_position=1),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            2,
        ),
        _rejected(
            ...
            DifferentialPurpose.FOREIGN_CANONICAL_TARGET_WITHOUT_A_DECLARATION,
            _document(
                _header(2),
                _OWNER,
                *_module_block(0, "a.pietto"),
                ...
                _type_resolution(
                    ...
                    canonical_target=("b.pietto", "Missing"),
                ),
                *_module_block(1, "b.pietto"),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
        ...
        _rejected(
            "facts_state_outside_its_declaration",
            DifferentialPurpose.FACTS_STATE_OUTSIDE_ITS_DECLARATION,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _semantic_facts(
                    ...
                    0,
                    status="concrete",
                    reason="relation_upstream_concrete",
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            8,
        ...
        _rejected(
            "source_lineage_with_a_derived_state",
            DifferentialPurpose.SOURCE_LINEAGE_WITH_A_DERIVED_STATE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _row_lineage(
                    ...
                    0,
                    status="deferred",
                    reason="deferred_phase48_behavior",
                    fields=0,
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
        ...
        _rejected(
            "origin_target_outside_its_declaration",
            DifferentialPurpose.ORIGIN_TARGET_OUTSIDE_ITS_DECLARATION,
            _document(
                _header(2),
                _OWNER,
                *_importing_module_block(
        ...
        _rejected(
            ...
            _document(
                ...
                *valid_module,
                ...
                _import_issue(0, 0, 0, "unknown_exported_name"),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            0,
        ),
        _rejected(
            "unresolved_target_of_a_selected_module",
            DifferentialPurpose.UNRESOLVED_TARGET_OF_A_SELECTED_MODULE,
            _document(
                _header(2),
                _OWNER,
                *_module_block(0, "a.pietto"),
        ...
        _rejected(
            "ambiguous_export_without_ambiguity",
            DifferentialPurpose.AMBIGUOUS_EXPORT_WITHOUT_AMBIGUITY,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "unresolved_export_with_a_candidate",
            DifferentialPurpose.UNRESOLVED_EXPORT_WITH_A_CANDIDATE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "local_export_of_ambiguous_declaration",
            DifferentialPurpose.LOCAL_EXPORT_OF_AMBIGUOUS_DECLARATION,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            ...
            DifferentialPurpose.DEPENDENCY_TARGET_OUTSIDE_ITS_DOMAIN,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _dependency(
                    ...
                    kind="source_shape_reference",
                    reference_role="source_shape",
                    declaration_target=("a.pietto", 0, "rows"),
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            9,
        ...
        _rejected(
            "local_lineage_root_outside_a_source",
            DifferentialPurpose.LOCAL_LINEAGE_ROOT_OUTSIDE_A_SOURCE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            ...
            DifferentialPurpose.DEPENDENCY_TARGET_OUTSIDE_ORIGINS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _dependency(
                    ...
                    0,
                    kind="type_reference",
                    reference_role="type_alias_base",
                    declaration_target=("a.pietto", 1, "Age"),
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            9,
        ...
        _rejected(
            "row_field_target_outside_origins",
            DifferentialPurpose.ROW_FIELD_TARGET_OUTSIDE_ORIGINS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "hopped_lineage_from_source_field",
            DifferentialPurpose.HOPPED_LINEAGE_FROM_SOURCE_FIELD,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "semantic_facts_in_blocked_module",
            DifferentialPurpose.SEMANTIC_FACTS_IN_BLOCKED_MODULE,
            _document(
                _header(1),
                _OWNER,
                _module(0, "a.pietto"),
        ...
        _rejected(
            "source_owner_with_derived_facts",
            DifferentialPurpose.SOURCE_OWNER_WITH_DERIVED_FACTS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "lineage_owner_outside_declarations",
            DifferentialPurpose.LINEAGE_OWNER_OUTSIDE_DECLARATIONS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _row_lineage(0, 0, owner_position=99),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            8,
        ),
        _rejected(
            "dependency_owner_outside_declarations",
            DifferentialPurpose.DEPENDENCY_OWNER_OUTSIDE_DECLARATIONS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "resolution_owner_outside_declarations",
            DifferentialPurpose.RESOLUTION_OWNER_OUTSIDE_DECLARATIONS,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            ...
            DifferentialPurpose.UNORDERED_DEPENDENCY_LEDGER,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _dependency(
                    ...
                    kind="relation_reference",
                    reference_role="relation_from",
                    declaration_target=("a.pietto", 0, "totals"),
                ),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            11,
        ...
        _rejected(
            "blocked_declaration_in_ready_module",
            DifferentialPurpose.BLOCKED_DECLARATION_IN_READY_MODULE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "cyclic_component_in_ready_module",
            DifferentialPurpose.CYCLIC_COMPONENT_IN_READY_MODULE,
            _document(
                _header(1),
                _OWNER,
                _module(0, "a.pietto"),
        ...
        _rejected(
            "zero_hop_lineage_outside_source",
            DifferentialPurpose.ZERO_HOP_LINEAGE_OUTSIDE_SOURCE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
            ...
            _document(
                ...
                *valid_module,
                _issue(
                    ...
                    0,
                    family="graph",
                    status="unsupported_explicit_module_reference",
                ),
        ...
        _rejected(
            "unordered_export_issue_statuses",
            DifferentialPurpose.UNORDERED_EXPORT_ISSUE_STATUSES,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _export_issue(0, 0, 0, "ambiguous_candidate_set"),
                _export_issue(0, 0, 1, "ambiguous_local_declaration"),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            9,
        ),
        _rejected(
            "empty_later_declared_name",
            DifferentialPurpose.EMPTY_LATER_DECLARED_NAME,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "empty_required_symbol_name",
            DifferentialPurpose.EMPTY_REQUIRED_SYMBOL_NAME,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "duplicate_row_field_name",
            DifferentialPurpose.DUPLICATE_ROW_FIELD_NAME,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _row_field(0, 0, 0, name="id"),
                _row_field(0, 0, 1, name="id"),
            ),
            ProjectPureStatus.INCONSISTENT_SCOPE_RELATION,
            9,
        ),
        _rejected(
            "projection_kind_name_mismatch",
            DifferentialPurpose.PROJECTION_KIND_NAME_MISMATCH,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "non_concrete_window_under_concrete",
            DifferentialPurpose.NON_CONCRETE_WINDOW_UNDER_CONCRETE,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
        ...
        _rejected(
            "duplicate_lineage_path",
            DifferentialPurpose.DUPLICATE_LINEAGE_PATH,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _row_field(0, 0, 0, name="id"),
                _row_lineage(0, 0, fields=1),
                _lineage_field(0, 0, 0, name="id", paths=2),
                _lineage_path(
                    0,
                    0,
                    0,
        ...
        _rejected(
            "duplicate_dependency_fact",
            DifferentialPurpose.DUPLICATE_DEPENDENCY_FACT,
            _document(
                _header(1),
                _OWNER,
                *valid_module,
                ...
                _dependency(
                    ...
                    kind="type_reference",
                    reference_role="type_alias_base",
                    declaration_target=("a.pietto", 0, "Age"),
                ),
                _dependency(
                    0,
                    1,
