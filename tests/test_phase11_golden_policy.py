...
GOLDEN_HASH = "7c721c040799b3310f919a141d5e4a45c82d49860b28250c1c0f2c0107727c82"
BOUNDARY_HASH = "8d7d3d58bbbd33360f02df7f7fb157e75c6e120d95efb547c05fc69965dd1352"
VALIDATION_GATES = (
...
def test_real_audit_runs_from_outside_the_repository(tmp_path: Path) -> None:
    ...
    assert "verified 21 fixtures" in result.stdout
    assert "16 SQL byte-exact" in result.stdout
