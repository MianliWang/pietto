...
def test_slice7_contract_test_inventory_and_active_gate_manifest_are_exact() -> None:
    ...
    assert PHASE54_ACTIVE_GATE2_MARKER == "PHASE54_SLICE14_GATE2"
    assert PHASE54_ACTIVE_GATE2_BASE == "040ab19c56519c39c56541979c850484f9cc47f0"
    ...
    assert len(PHASE54_ACTIVE_GATE2_MODIFIED_PATHS) == 63
