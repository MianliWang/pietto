...
static audit, and status work only. Slice 8 is complete as completion audit
and status lock work only. Phase 30 is complete as docs/spec/static-audit/status
work only, but v0.2 is not complete. Phase 31 and Phase 32 remain required
