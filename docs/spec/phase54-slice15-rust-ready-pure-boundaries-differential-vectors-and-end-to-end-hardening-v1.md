...
| ledger match | one record, alone or with its scope, against a collection the enclosing scope published | the first hop of an imported origin is that origin's own import request, and a local origin names a declaration of its own module |
