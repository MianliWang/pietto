...
| sibling buckets complete | the siblings of one kind, grouped by a declared key tuple | a repeated nominal identity publishes its whole occurrence bucket, once per index |
