...
| `source_shape_resolution`, `relation_resolution` | the owner is a declaration of this module of the kind the record admits, a shaped source or a table or query; owners ascend, so one declaration resolves once in source order | `ProjectModuleSourceShapeReference`, `ProjectModuleRelationReference` |
