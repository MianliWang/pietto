...
| grouped ascends by collected | one child collection ranked by another collected in document order | a module's dependency targets follow selected module order |
