...
| previous sibling non-decreasing | the immediately preceding sibling of the same kind, in its declared enumeration order | clause dependencies appear grouped by role, in the order the ledger builds them |
