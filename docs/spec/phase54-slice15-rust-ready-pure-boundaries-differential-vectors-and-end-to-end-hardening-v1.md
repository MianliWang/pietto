...
| grouped groups agree | the child collections of every scope, ranked by another collected in document order | every member of a graph component publishes that same component, which is what a partition means |
